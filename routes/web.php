...
Route::post('/dashboard/posts/{post:slug}', [DashboardPostController::class, 'update'],);
...
Route::resource('/dashboard/keluars', KeluarController::class)->middleware('auth');

Route::get('/dashboard/createk', [KeluarController::class, 'create'],);

Route::resource('/laporan', LaporanController::class);

Route::get('/cetak/{tang}/{tangg}', [DashboardPostController::class, 'cetak']);
