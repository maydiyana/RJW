...
<div class="pagar" style="display: flex; justify-content: center;">
    <a href="https://www.instagram.com/abmaydiyana/" class="btn" style="background-color: #a7a9be"><i class="bi bi-instagram"></i> abmaydiyana</a>
<a href="https://wa.me/628815227120" class="btn ms-3" style="background-color: #a7a9be"><i class="bi bi-whatsapp"></i> +628815227120</a>
</div>
        ...
        @enderror
         ...
         <div class="mb-3">
           ...
           <div class="mb-3">
            ...
            <input type="text" class="form-control" name="pengirim" id="pengirim" value="{{ old('pengirim', $post->pengirim) }}">
           </div>
           <div class="mb-3">
            <label for="penerima" class="form-label">Penerima</label>
            <input type="text" class="form-control" name="penerima" id="penerima" value="{{ old('penerima', $post->penerima) }}">
           </div>
           <div class="mb-3">
            <label for="berat" class="form-label">Berat</label>
            <input type="text" class="form-control" name="berat" id="berat" placeholder="Satuan (KG)" value="{{ old('berat', $post->berat) }}">
           </div>
           <div class="mb-3">
            <label for="tanggal" class="form-label">Tanggal Masuk</label>
            <input type="datetime-local" class="form-control" name="tanggal" id="tanggal" value="{{ old('tanggal', $post->tanggal) }}">
           </div>
           <div class="mb-3">
            <label for="tanggalkeluar" class="form-label">Tanggal Keluar</label>
            <input type="datetime-local" class="form-control" name="tanggalkeluar" id="tanggalkeluar" >
           </div>
           <div class="mb-3">
